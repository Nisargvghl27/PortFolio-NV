...
// Mapping of custom SVG icons for each skill (matching official branding colors)
...
const skillsData = [
  { name: 'TypeScript', category: 'Languages', color: 'hover:text-[#3178C6] hover:border-[#3178C6]/50 hover:bg-[#3178C6]/5' },
  { name: 'JavaScript', category: 'Languages', color: 'hover:text-[#F7DF1E] hover:border-[#F7DF1E]/50 hover:bg-[#F7DF1E]/5' },
  { name: 'Python', category: 'Languages', color: 'hover:text-[#3776AB] hover:border-[#3776AB]/50 hover:bg-[#3776AB]/5' },
  { name: 'Dart', category: 'Languages', color: 'hover:text-[#0175C2] hover:border-[#0175C2]/50 hover:bg-[#0175C2]/5' },
  { name: 'C++', category: 'Languages', color: 'hover:text-[#00599C] hover:border-[#00599C]/50 hover:bg-[#00599C]/5' },
  { name: 'Java', category: 'Languages', color: 'hover:text-[#ED8B00] hover:border-[#ED8B00]/50 hover:bg-[#ED8B00]/5' },
  
  { name: 'Next.js', category: 'Frontend', color: 'hover:text-white hover:border-white/50 hover:bg-white/5' },
  { name: 'React', category: 'Frontend', color: 'hover:text-[#61DAFB] hover:border-[#61DAFB]/50 hover:bg-[#61DAFB]/5' },
  { name: 'Tailwind CSS', category: 'Frontend', color: 'hover:text-[#06B6D4] hover:border-[#06B6D4]/50 hover:bg-[#06B6D4]/5' },
  { name: 'Framer Motion', category: 'Frontend', color: 'hover:text-[#F024B6] hover:border-[#F024B6]/50 hover:bg-[#F024B6]/5' },
  { name: 'Flutter', category: 'Frontend', color: 'hover:text-[#02569B] hover:border-[#02569B]/50 hover:bg-[#02569B]/5' },
  
  { name: 'Node.js', category: 'Backend', color: 'hover:text-[#339933] hover:border-[#339933]/50 hover:bg-[#339933]/5' },
  { name: 'Express', category: 'Backend', color: 'hover:text-gray-300 hover:border-gray-500/50 hover:bg-gray-500/5' },
  { name: 'PostgreSQL', category: 'Backend', color: 'hover:text-[#4169E1] hover:border-[#4169E1]/50 hover:bg-[#4169E1]/5' },
  { name: 'Prisma', category: 'Backend', color: 'hover:text-white hover:border-white/50 hover:bg-white/5' },
  { name: 'Supabase', category: 'Backend', color: 'hover:text-[#3ECF8E] hover:border-[#3ECF8E]/50 hover:bg-[#3ECF8E]/5' },
  { name: 'REST APIs', category: 'Backend', color: 'hover:text-cyan-400 hover:border-cyan-500/50 hover:bg-cyan-500/5' },
  
  { name: 'Git', category: 'Tools_&_DevOps', color: 'hover:text-[#F05032] hover:border-[#F05032]/50 hover:bg-[#F05032]/5' },
  { name: 'GitHub', category: 'Tools_&_DevOps', color: 'hover:text-white hover:border-white/50 hover:bg-white/5' },
  { name: 'Docker', category: 'Tools_&_DevOps', color: 'hover:text-[#2496ED] hover:border-[#2496ED]/50 hover:bg-[#2496ED]/5' },
  { name: 'Vercel', category: 'Tools_&_DevOps', color: 'hover:text-white hover:border-white/50 hover:bg-white/5' },
  { name: 'Linux', category: 'Tools_&_DevOps', color: 'hover:text-[#FCC624] hover:border-[#FCC624]/50 hover:bg-[#FCC624]/5' },
  { name: 'Postman', category: 'Tools_&_DevOps', color: 'hover:text-[#FF6C37] hover:border-[#FF6C37]/50 hover:bg-[#FF6C37]/5' }
]
...
export default function Skills() {
  ...
  return (
    <div className="font-mono space-y-10 w-full max-w-4xl mx-auto relative px-4">
        ...
        <div className="flex flex-wrap gap-2.5 justify-center border-b border-white/10 pb-6">
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                {/* Micro corner brackets inside the button for cyberpunk detail */}
                {isActive && (
                  <>
      ...
      {/* 2. Cyber-Grid Container */}
      <FadeIn delay={0.2} direction="up">
        <div className="relative glass-panel p-8 glow-border-hover min-h-[220px] flex flex-col justify-center border border-white/10 rounded-lg overflow-hidden bg-black/60 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          {/* Animated Background Grid lines (Horizontal and Vertical) */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none" />
          
          {/* Neon corner intersects (+) */}
          ...
          >
            <AnimatePresence mode="popLayout">
              {filteredSkills.map((skill) => (
                ...
                >
                  {/* Decorative tiny corner bracket details inside active tags on hover */}
                  ...
                  {/* Skill Text */}
                  <span className="relative tracking-wider font-semibold group-hover:animate-pulse">
                    {skill.name}
                  </span>
                </motion.span>
              ))}
