      ...
      <div className="px-4 py-3 bg-white/5 border-t border-white/10 flex flex-wrap gap-2 items-center justify-between">
        <div className="flex flex-wrap gap-1.5">
          <button
            ...
            className={`px-2 py-1 border rounded text-[10px] uppercase transition-all select-none ${activeCommand ? 'border-gray-800 text-gray-600 cursor-not-allowed' : 'border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-400/50'
              }`}
          >
            specs.sh
          </button>
        ...
        <button
          ...
          disabled={activeCommand !== null}
          suppressHydrationWarning
          className={`px-2 py-1 text-[10px] uppercase rounded border transition-all select-none ${activeCommand ? 'border-gray-800 text-gray-600 cursor-not-allowed' : 'border-red-500/20 text-red-400 hover:bg-red-500/10 hover:border-red-500/40'
            }`}
        >
          Clear
        </button>
