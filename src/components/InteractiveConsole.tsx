...
const COMMAND_DATA: Record<string, string[]> = {
  './specs.sh': [
    ...
    'FOCUS: Scalable Web Apps & Applied AI',
    'STACK: Next.js, React, FastAPI, Flutter',
  ...
  './skills.sh': [
    ...
    'FRAMEWORKS: Next.js, React, FastAPI, Node.js, Flutter',
    'AI / RAG  : LlamaIndex, FAISS, Groq LLM integration',
    'DEV & DB  : Supabase, MongoDB, Firebase, Git, FFmpeg',
    '--------------------------------------',
  ...
  './contact.sh': [
    ...
    'EMAIL    : nisargvaghela103@gmail.com',
