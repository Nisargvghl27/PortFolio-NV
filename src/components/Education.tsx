        ...
        {educationData.map((item, index) => (
          <FadeIn key={item.id} delay={0.1 + index * 0.15} direction="right">
            <div className="relative group bg-[#0a0f12]/80 backdrop-blur-sm border border-[#00f0ff]/20 hover:border-[#00f0ff]/60 p-6 rounded-md transition-all duration-300 shadow-[0_0_20px_rgba(0,240,255,0.02)] hover:shadow-[0_0_20px_rgba(0,240,255,0.1)]">
              ...
              <span className="absolute top-0 left-0 w-1.5 h-1.5 border-t border-l border-[#00f0ff]/40 group-hover:border-[#00f0ff] transition-colors" />
              <span className="absolute bottom-0 right-0 w-1.5 h-1.5 border-b border-r border-[#00f0ff]/40 group-hover:border-[#00f0ff] transition-colors" />
              
              {/* Header metrics */}
              <div className="flex flex-wrap items-center justify-between gap-2 mb-4 select-none">
                <span className="text-[10px] font-bold text-[#00f0ff] tracking-widest uppercase bg-[#00f0ff]/10 px-3 py-1 border border-[#00f0ff]/30 rounded-sm">
                  {item.period}
                </span>
              ...
              {/* Title & Organization */}
              <h3 className="text-lg font-bold text-white mb-1 group-hover:text-[#00f0ff] transition-colors duration-300 uppercase tracking-wide">
                {item.title}
              </h3>
