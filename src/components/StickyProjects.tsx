    ...
    return (
        <div ref={containerRef} style={{ height: containerHeight }} className="relative w-full">
            <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
                ...
                {/* PINNED HEADER - Adjusted top positioning for mobile */}
                ...
                {/* CONTENT WRAPPER - Increased top padding to clear header on mobile */}
                <div className="w-full max-w-7xl mx-auto px-6 relative z-10 pt-28 md:pt-16">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            // Reduced mobile gap from gap-8 to gap-4
                ...
                {/* Progress Indicator - FIX: Changed left-30 to left-1/2 to perfectly center it */}
...
function ProjectImage({ project }: { project: Project }) {
    return (
        // FIX: Added max-h-[30vh] for mobile so tall images don't push text off-screen
        <div className="w-full lg:w-1/2 relative glass-panel rounded-md overflow-hidden aspect-video max-h-[30vh] md:max-h-none border border-[#00f0ff]/30 shadow-[0_0_30px_rgba(0,240,255,0.05),inset_0_0_20px_rgba(0,240,255,0.02)]">
            {/* Terminal Header - Hidden on very small screens to save space */}
                        ...
                        <span className="relative z-10 flex items-center group-hover:text-white transition-colors">
                            ...
                            <motion.span
                                variants={{
                                    ...
                                    hover: { opacity: [1, 0, 1], width: "auto", marginLeft: "6px" }
                                }}
